...
std::vector<std::vector<int>> PathPlanner::planPath(GPS currentGPS, GPS goal) {
    ...
    Location currentNode = getLocation(currentGPS);
    ...
    currentNode.fScore = get_fScore(currentNode);
