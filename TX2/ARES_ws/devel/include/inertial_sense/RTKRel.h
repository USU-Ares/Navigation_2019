...
struct RTKRel_
{
  ...
  _ar_ratio_type ar_ratio;
   ...
   typedef  ::geometry_msgs::Vector3_<ContainerAllocator>  _vector_to_base_type;
  _vector_to_base_type vector_to_base;

   typedef float _distance_to_base_type;
  _distance_to_base_type distance_to_base;

   typedef float _heading_to_base_type;
  _heading_to_base_type heading_to_base;
...
// {'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'inertial_sense': ['/home/nvidia/ARES_ws/src/inertial_sense_ros/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
struct MD5Sum< ::inertial_sense::RTKRel_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x08bc407c0d6e7678ULL;
  static const uint64_t static_value2 = 0xdc9accbcee16cae9ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::inertial_sense::RTKRel_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.vector_to_base);
      stream.next(m.distance_to_base);
      stream.next(m.heading_to_base);
    }
...
struct Printer< ::inertial_sense::RTKRel_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::inertial_sense::RTKRel_<ContainerAllocator>& v)
  {
    ...
    s << indent << "vector_to_base: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.vector_to_base);
    s << indent << "distance_to_base: ";
    Printer<float>::stream(s, indent + "  ", v.distance_to_base);
    s << indent << "heading_to_base: ";
    Printer<float>::stream(s, indent + "  ", v.heading_to_base);
  }
};
