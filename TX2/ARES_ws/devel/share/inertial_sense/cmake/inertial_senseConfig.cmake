...
if(NOT "/home/nvidia/ARES_ws/devel/include;/home/nvidia/ARES_ws/src/inertial_sense_ros/include " STREQUAL " ")
  set(inertial_sense_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/ARES_ws/devel/include;/home/nvidia/ARES_ws/src/inertial_sense_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'inertial_sense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/ARES_ws/src/inertial_sense_ros/${idir}'.  ${_report}")
    endif()
