...
(cl:defclass <RTKRel> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (ar_ratio
    ...
    :initform 0.0)
   (vector_to_base
    :reader vector_to_base
    :initarg :vector_to_base
    :type geometry_msgs-msg:Vector3
    :initform (cl:make-instance 'geometry_msgs-msg:Vector3))
   (distance_to_base
    :reader distance_to_base
    :initarg :distance_to_base
    :type cl:float
    :initform 0.0)
   (heading_to_base
    :reader heading_to_base
    :initarg :heading_to_base
    :type cl:float
    :initform 0.0))
)
...
(cl:ensure-generic-function 'vector_to_base-val :lambda-list '(m))
(cl:defmethod vector_to_base-val ((m <RTKRel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inertial_sense-msg:vector_to_base-val is deprecated.  Use inertial_sense-msg:vector_to_base instead.")
  (vector_to_base m))

(cl:ensure-generic-function 'distance_to_base-val :lambda-list '(m))
(cl:defmethod distance_to_base-val ((m <RTKRel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inertial_sense-msg:distance_to_base-val is deprecated.  Use inertial_sense-msg:distance_to_base instead.")
  (distance_to_base m))

(cl:ensure-generic-function 'heading_to_base-val :lambda-list '(m))
(cl:defmethod heading_to_base-val ((m <RTKRel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inertial_sense-msg:heading_to_base-val is deprecated.  Use inertial_sense-msg:heading_to_base instead.")
  (heading_to_base m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RTKRel>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'ar_ratio))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'vector_to_base) ostream)
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'distance_to_base))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'heading_to_base))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RTKRel>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'vector_to_base) istream)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'distance_to_base) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'heading_to_base) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RTKRel>)))
  ...
  "08bc407c0d6e7678dc9accbcee16cae9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RTKRel)))
  "Returns md5sum for a message object of type 'RTKRel"
  "08bc407c0d6e7678dc9accbcee16cae9")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RTKRel>))
  (cl:+ 0
     ...
     4
     4
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'vector_to_base))
     4
     4
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RTKRel>))
  ...
  (cl:list 'RTKRel
    ...
    (cl:cons ':vector_to_base (vector_to_base msg))
    (cl:cons ':distance_to_base (distance_to_base msg))
    (cl:cons ':heading_to_base (heading_to_base msg))
))
